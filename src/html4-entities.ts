    ...
    encodeNonUTF(str: string) {
        ...
        while (i < strLength) {
            ...
            if (alpha) {
                ...
                if (cc >= highSurrogateFrom && cc <= highSurrogateTo) {
